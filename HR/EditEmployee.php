<?php
    ...
    $sql = "SELECT * FROM employeestbl WHERE emp_id=$id";
    ...
    if($_POST)
    {
        if(isset($_POST["update"]))
        {
            ...
            $sql = "UPDATE `employeestbl` SET `firstName`='$firstName', `lastName`='$lastName', `jobTitle`='$jobTitle', `department`='$department', `email`='$email' WHERE emp_id=$id";
            $result = $DBConnect->query($sql);
            ...
            <div id="content">
                ...
                <div class="login-box">
                    <div class="login-box-body">
                        <h1 class="login-box-msg">Edit Employee</h1>       
                        <form action="EditEmployee.php?id=<?php print $id; ?>" method="POST" >
                            ...
                            <input type="submit" name="update" class="btn btn-primary" value="Update"/>&nbsp;<input type="reset" class="btn btn-outline-primary" value="Clear"/>&nbsp;<a href="ViewEmployees.php"><input type="cancel" class="btn btn-outline-secondary" value="Cancel"/></a>
                        </form>
