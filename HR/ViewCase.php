                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 right-align">
                                    ...
                                    <?php
                                        ...
                                        if($no_of_charges < 1)
                                        {
                                            echo '<button type="button" class="btn btn-danger disabled"><i class="fas fa-gavel"></i> Close Case</button>';
                                        }
                                        else
                                        {
                                            echo '<a href="EditClosing.php?id=' . $id .'"><button type="button" class="btn btn-danger"><i class="fas fa-gavel"></i> Close Case</button></a>';
                                        }
                                    ...
                                    while($row = mysqli_fetch_array($QueryResult2))
                                    {
                                        echo "
                                            <tr>
                                              ...
                                              </svg></a> | <a href ='DeleteCharge.php?id= " . $row['charge_id'] . "'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash' viewBox='0 0 16 16'>
