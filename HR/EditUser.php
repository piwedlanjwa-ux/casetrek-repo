<?php
    ...
    if($_POST)
    {
        if(isset($_POST["update"]))
        {
            ...
            $sql = "UPDATE `userstbl` SET `firstName`='$firstName', `lastName`='$lastName', `email`='$email', `password`='$password', `userType`='$userType', `jobTitle`='$position'   WHERE user_id=$id";
            $result = $DBConnect->query($sql);
            ...
            <div id="content">
                ...
                <div class="login-box">
                    <div class="login-box-body">
                        <h1 class="login-box-msg">Edit User</h1>       
                        <form action="EditUser.php?id=<?php print $id; ?>" method="POST" >
                            
                            <div class="form-group row">
                                <div class="col-sm-3"><label>First Name</label></div>
                                <div class="col-sm-7"><input class="form-control" type="text" name="firstName" placeholder="First name" value="<?php print $row['firstName']; ?>" /></div>
                                <span class="help-block"></span>
                            </div>                        
                            
                            <div class="form-group row ">
                                <div class="col-sm-3"><label>Last Name</label></div>
                                <div class="col-sm-7"><input class="form-control" type="text" name="lastName" placeholder="Last name" value="<?php print $row['lastName']; ?>" /></div>
                                <span class="help-block"></span>
                            </div>
                            
                            <div class="form-group row">
                                <div class="col-sm-3"><label>Email</label></div>
                                <div class="col-sm-7"><input class="form-control" type="text" name="email" placeholder="Email address" value="<?php print $row['email']; ?>" /></div>
                                <span class="help-block"></span>
                            </div><br>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-7">
                                    <select class="form-control" type="text" name="jobTitle" value="<?php echo $position; ?>">
                            ...
                            <input type="submit" name="update" class="btn btn-primary" value="Update"/>&nbsp;<input type="reset" class="btn btn-outline-primary" value="Clear"/>&nbsp;<a href="ViewUsers.php"><input type="cancel" class="btn btn-outline-secondary" value="Cancel"/></a>
                        </form>
