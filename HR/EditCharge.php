                ...
                <div class="login-box">
                    <div class="login-box-body">
                        ...
                        <form action="EditCharge.php?id=<?php print $id; ?>" method="POST" >
                            ...
                            <input type="submit" name="update" class="btn btn-primary" value="Update"/>&nbsp;<input type="reset" class="btn btn-outline-primary" value="Clear"/>&nbsp;<a href="ViewCase.php?id=<?php print $row['case_id'] ?>"><input type="cancel" class="btn btn-outline-secondary" value="Cancel"/></a>
                        </form>
