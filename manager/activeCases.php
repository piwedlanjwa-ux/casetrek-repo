                ...
                <div class='login-box'>
                    <div class='login-box-body'>
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3><b>Active Cases</b></h3></div>
                                <div class="col-sm-4">
                        ...
                        <div class='table-responsive-sm'>
                            <table id='example' class='table table-hover table-striped table-sm'>
                                ...
                                <?php
                                    ...
                                    $SQLString = "SELECT * FROM `closed_casestb` WHERE `status`='Open' ORDER BY `case_id` DESC";
                                    $QueryResult = $DBConnect->query($SQLString);

                                    $session_email = htmlspecialchars($_SESSION["email"]);

                                    $SQL = "SELECT * FROM employeestbl WHERE `email`='$session_email'";
                                    $Result = $DBConnect->query($SQL);
                                    $dept_row = mysqli_fetch_array($Result);

                                    $current_department = $dept_row['department'];

                                    if($rows = mysqli_fetch_array($QueryResult))
                                    {
                                        $SQLString3 = "SELECT * FROM `casestb` WHERE `department`='$current_department'";
                                        $QueryResult3 = $DBConnect->query($SQLString3);

                                        while($rowz = mysqli_fetch_array($QueryResult3))
                                        {
                                            $id=$rows['case_id'];
                                        ...
                                        echo "No Open cases for your department";
