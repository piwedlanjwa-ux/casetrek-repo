<?php
    ...
    $sql = "SELECT * FROM chargestb WHERE charge_id=$id";
    ...
    if($_POST)
    {
        if(isset($_POST["update"]))
        {
            ...
            $sql = "UPDATE `chargestb` SET `description`='$description', `verdict`='$verdict', `category`='$category', `subcategory`='$subcategory', WHERE charge_id=$id";
            $result = $DBConnect->query($sql);

            if($result)
            {
                header("Location: ViewCase.php?id= " . $row['case_id'] . "");
            }
            else
            {
            ...
            <div id="content">
                ...
                <div class="login-box">
                    <div class="login-box-body">
                        <h1 class="login-box-msg">Edit Charge</h1>       
                        <form action="EditCharge.php?id=<?php print $id; ?>" method="POST" >
                            
                            <div class="form-group row ">
                                <div class="col-sm-3"><label>Category</label></div>
                                <div class="col-sm-7">
                                    <select class="form-control" type="text" name="category" value="<?php echo $category; ?>">
                                        <option selected><?php print $row['category']; ?></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                        ...
                                        <option selected><?php print $row['subcategory']; ?></option>
                                            <?php
                            ...
                            <input type="submit" name="update" class="btn btn-primary" value="Update"/>&nbsp;<input type="reset" class="btn btn-outline-primary" value="Clear"/>&nbsp;<a href="ViewCase.php?id=<?php print $case_id ?>"><input type="cancel" class="btn btn-outline-secondary" value="Cancel"/></a>
                        </form>
