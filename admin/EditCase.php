<?php
    ...
    $sql = "SELECT * FROM casestb WHERE case_id=$id";
    ...
    if($_POST)
    {
        if(isset($_POST["update"]))
        {
            ...
            $employer_rep = $_POST["employer_rep"];
            $date_of_sitting = $_POST["date_of_sitting"];
            $chairman = $_POST["chairman"];

            $sql = "UPDATE `casestb` SET `employee_name`='$employee_name', `department`='$department', `position`='$position', `employer_rep`='$employer_rep', `date_of_sitting`='$date_of_sitting', `chairman`='$chairman' WHERE case_id=$id";
            $result = $DBConnect->query($sql);
            ...
            <div id="content">
                        ...
                        <ul class=" navbar-right">
                            <li class="nav-item dropdown open show" style="padding-left: 15px;">
                                ...
                                <div class="dropdown-menu dropdown-usermenu pull-right " aria-labelledby="navbarDropdown" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(10px, 21px, 0px);">
                                    ...
                                    <a class="dropdown-item" href="/logout.php"><img src="https://img.icons8.com/metro/17/000000/exit.png"> Log Out</a>
                                </div>
                            </li>
                ...
                <div class="login-box">
                    <div class="login-box-body">
                        <h1 class="login-box-msg">Edit Case</h1>       
                        <form action="EditCase.php?id=<?php print $id; ?>" method="POST" >
                            
                            <div class="form-group row">
                                <div class="col-sm-3"><label>Employee Name</label></div>
                                <div class="col-sm-7">
                                    <select class="form-control" type="text" name="employee_name" value="<?php 
                                        ...
                                        <option selected><?php print $row['employee_name']; ?></option>
                                        <?php
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select class="form-control" type="text" name="department" value="<?php 
                                        $SQLString = "SELECT * FROM `casestb` WHERE case_id=$id";
                                        $QueryResult = $DBConnect->query($SQLString);
                                        ...
                                        <option selected><?php print $row['department']; ?></option>
                                        <?php
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select class="form-control" type="text" name="position" value="<?php 
                                        $SQLString = "SELECT * FROM `casestb` WHERE case_id=$id";
                                        $QueryResult = $DBConnect->query($SQLString);
                                        ...
                                        print $row['position'];?>">
                                        <option selected><?php print $row['position']; ?></option>
                                        <?php
                            ...
                            <div class="for-group row">
                                ...
                                <div class="col-sm-7">
                                    <select class="form-control" type="text" name="employer_rep" value="<?php 
                                        $SQLString = "SELECT * FROM `casestb` WHERE case_id=$id";
                                        $QueryResult = $DBConnect->query($SQLString);

                                        $row = mysqli_fetch_array($QueryResult);

                                        print $row['employer_rep'];?>">
                                        <option selected><?php print $row['employer_rep']; ?></option>
                                        <?php
                                            $query = "SELECT emp_id, firstName, lastName FROM employeestbl ORDER BY firstName";
                                            $r_set = $DBConnect->query($query);
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7"><input class="form-control" type="date" name="date_of_sitting" value="<?php 
                                        $SQLString = "SELECT * FROM `casestb` WHERE case_id=$id";
                                        $QueryResult = $DBConnect->query($SQLString);

                                        $row = mysqli_fetch_array($QueryResult);

                                        print $row['date_of_sitting'];?>"
                                         /></div>
                                <span class="help-block"></span>
                            </div>                        
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-7"><input class="form-control" type="text" name="chairman" placeholder="First name & Last name" value="<?php print $row['chairman'];?>" /></div>
                                <span class="help-block">
                                
                                </span>
                            </div>
                                        
                            <input type="submit" name="update" class="btn btn-primary" value="Update"/>&nbsp;<input type="reset" class="btn btn-outline-primary" value="Clear"/>&nbsp;<a href="ViewCase.php?id=<?php print $id; ?>"><input type="cancel" class="btn btn-outline-secondary" value="Cancel"/></a>
                        </form>
