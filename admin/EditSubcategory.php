<?php
    ...
    $sql = "SELECT * FROM charge_subcategorytbl WHERE subcategory_id=$id";
    ...
    if($_POST)
    {
        if(isset($_POST["update"]))
        {
            ...
            $sql = "UPDATE `charge_subcategorytbl` SET `subcategory_name`='$subcategory_name',  `category`='$category' WHERE subcategory_id=$id";
            $result = $DBConnect->query($sql);
            ...
            <div id="content">
                ...
                <div class="login-box">
                    <div class="login-box-body">
                        <h1 class="login-box-msg">Edit Subcategory</h1>       
                        <form action="EditSubcategory.php?id=<?php print $id; ?>" method="POST" >
                            
                            <div class="for-group row">
                                <div class="col-sm-3"><label>Subcategory</label></div>
                                <div class="col-sm-7"><input class="form-control" type="text" name="subcategory_name" placeholder="Subcategory Name" value="<?php print $row['subcategory_name']; ?>" /></div>
                                <span class="help-block"></span>
                            </div><br>

                            <div class="form-group row ">
                                <div class="col-sm-3"><label>Gategory</label></div>
                                <div class="col-sm-7">
                            ...
                            <input type="submit" name="update" class="btn btn-primary" value="Update"/>&nbsp;<input type="reset" class="btn btn-outline-primary" value="Clear"/>&nbsp;<a href="ViewSubcategories.php"><input type="cancel" class="btn btn-outline-secondary" value="Cancel"/></a>
                        </form>
