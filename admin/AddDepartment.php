<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){    
        ...
        else
        {
            ...
            $sql = "SELECT dept_id FROM departments WHERE department = ?";
            ...
            if($stmt = mysqli_prepare($DBConnect, $sql)){
                ...
                if(mysqli_stmt_execute($stmt)){
                    ...
                    if(mysqli_stmt_num_rows($stmt) == 1){
                        $department_err = "Department with this name already exists.";
                    } else{
        ...
        <div id="content">
            ...
            <div class="login-box">
                <div class="login-box-body">
                    <h1 class="login-box-msg">Add Department</h1>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                         <div class="form-group row <?php echo (!empty($department_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-sm-7"><input type="text" class="form-control" id="department" name="department" placeholder="Name of department" value="<?php echo $department; ?>" /></div>
                            <span class="help-block"><?php echo $department_err; ?></span>
                         </div>
                        <input type="submit" class="btn btn-primary" value="Add"/>&nbsp;<input type="reset" class="btn btn-outline-primary" value="Clear"/>&nbsp;<a href="ViewDepartments.php"><input type="cancel" class="btn btn-outline-secondary" value="Cancel"/></a>
