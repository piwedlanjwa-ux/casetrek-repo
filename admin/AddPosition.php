<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){    
        ...
        if(empty($position_err)){
            ...
            $sql = "INSERT INTO positions (position, department) VALUES (?, ?)";
            
            if($stmt = mysqli_prepare($DBConnect, $sql)){
                // Bind variables to the prepared statement as parameters
                mysqli_stmt_bind_param($stmt, "ss", $param_position, $param_department);
            ...
            <div id="content">
                ...
                <div class="login-box">
                    <div class="login-box-body">
                        <h1 class="login-box-msg">Add Job Title</h1>

                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                            <div class="form-group row <?php echo (!empty($position_err)) ? 'has-error' : ''; ?>">
                                <div class="col-sm-3"><label>Job Title</label></div>
                                <div class="col-sm-7"><input type="text" class="form-control" id="position" name="position" placeholder="Name of Job Title" value="<?php echo $position; ?>" required/></div>
                            ...
                            <input type="submit" class="btn btn-primary" value="Add"/>&nbsp;<input type="reset" class="btn btn-outline-primary" value="Clear"/>&nbsp;<a href="ViewPositions.php"><input type="cancel" class="btn btn-outline-secondary" value="Cancel"/></a>
