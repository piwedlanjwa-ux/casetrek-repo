    ...
    if (isset($_POST["import"])) {
        ...
        if ($_FILES["file"]["size"] > 0) {
            ...
            while (($column = fgetcsv($file, 10000, ",")) !== FALSE) {
                ...
                $department= "";
                if (isset($column[0])) {
                    $department = mysqli_real_escape_string($connect, $column[0]);
                } 
                
                $sqlInsert = "INSERT into departments (department)
                       values (?)";
                $paramType = "s";
                $paramArray = array(
                    $department
                ...
                <div class='login-box'>
                    <div class='login-box-body'>
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3><b>Departments</b></h3></div>
                                <div class="col-sm-4">
                                    <a href="AddDepartment.php"><button type="button" class="btn btn-primary add-new"><i class="fa fa-plus"></i> New Department</button></a>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                        ...
                        <?php
                            ...
                            if($QueryResult)
                            {
                                if($QueryResult->num_rows>0)
                                {
                                    ...
                                    echo "<tr><th></th><th>Department</th><th>Action</th></tr>";
                                    while($row = $QueryResult->fetch_assoc())
                                    {
                                        echo "<tr><td></td>";
                                        echo "<td>". $row['department'] . "</td>";
                                        echo "<td><a href ='EditDepartment.php?id= " . $row['dept_id'] . "'>Edit</a> | <a href ='DeleteDepartment.php?id= " . $row['dept_id'] . "'>Delete</a></td></tr>";
                                    }
                                    echo "</table>";
