<?php
    ...
    if($_POST)
    {
        if(isset($_POST["update"]))
        {
            ...
            $sql = "UPDATE `departments` SET `department`='$department' WHERE dept_id=$id";
            $result = $DBConnect->query($sql);
            ...
            <div id="content">
                ...
                <div class="login-box">
                    <div class="login-box-body">
                        <h1 class="login-box-msg">Edit Department</h1>       
                        <form action="EditDepartment.php?id=<?php print $id; ?>" method="POST" >
                            
                            <div class="for-group row">
                                <div class="col-sm-3"><label>Department</label></div>
                                <div class="col-sm-7"><input class="form-control" type="text" name="department" placeholder="Department Name" value="<?php print $row['department']; ?>" /></div>
                                <span class="help-block"></span>
                            </div><br>
                                                                   
                            <input type="submit" name="update" class="btn btn-primary" value="Update"/>&nbsp;<input type="reset" class="btn btn-outline-primary" value="Clear"/>&nbsp;<a href="ViewDepartments.php"><input type="cancel" class="btn btn-outline-secondary" value="Cancel"/></a>
                        </form>
