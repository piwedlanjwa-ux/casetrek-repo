<?php
    ...
    $subcategory_name_err = "";
    
    // Processing form data when form is submitted
    if($_SERVER["REQUEST_METHOD"] == "POST"){    
        //Validate subcategory_name
        if(empty(trim($_POST["subcategory_name"])))
        {
            $subcategory_name_err = "Please enter subcategory_name";
        }
        else
        {
        ...
        if(empty($subcategory_name_err)){
            
            // Prepare an insert statement
            $sql = "INSERT INTO charge_subcategorytbl(subcategory_name, category) VALUES (?, ?)";
            
            if($stmt = mysqli_prepare($DBConnect, $sql)){
                // Bind variables to the prepared statement as parameters
                mysqli_stmt_bind_param($stmt, "ss", $param_subcategory_name, $param_category);
                
                // Set parameters
                $param_subcategory_name = $subcategory_name;
            ...
            <div id="content">
                ...
                <div class="login-box">
                    <div class="login-box-body">
                        <h1 class="login-box-msg">Add Offence</h1>

                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                            <div class="form-group row <?php echo (!empty($subcategory_name_err)) ? 'has-error' : ''; ?>">
                                <div class="col-sm-3"><label>Offences</label></div>
                                <div class="col-sm-7"><input type="text" class="form-control" id="subcategory_name" name="subcategory_name" placeholder="Name of Subcategory" value="<?php echo $subcategory_name; ?>" required/></div>
                                <span class="help-block"><?php echo $subcategory_name_err; ?></span>
                            </div>     
                            ...
                            <input type="submit" class="btn btn-primary" value="Add"/>&nbsp;<input type="reset" class="btn btn-outline-primary" value="Clear"/>&nbsp;<a href="ViewSubcategories.php"><input type="cancel" class="btn btn-outline-secondary" value="Cancel"/></a>
